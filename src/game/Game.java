...
public class Game implements java.io.Serializable {
    ...
    private void initGame() {
        ...
        Room Jungle05               = new Room();
            Jungle05List.add(new Thing("moss", "A handful of tree moss", Jungle05));
            Jungle05List.add(new Thing("wood", "A log of Royal Palm wood", Jungle05));
            Jungle05List.add(new Thing("vines", "Thick vines, good for making rope", Jungle05));
        Room Cave06                 = new Room();
        Room Jungle07               = new Room();
            Jungle07List.add(new Thing("vines", "Thick vines, good for making rope", Jungle07));
        Room Jungle08               = new Room();
            Jungle08List.add(new Thing("moss", "A handful of tree moss", Jungle08));
        ...
        Room Jungle12               = new Room();
            Jungle12List.add(new Thing("wood", "A log of Royal Palm wood", Jungle12));
            Jungle12List.add(new Thing("palm-leaves", "Large leaves, fallen from the Royal Palms overhead", Jungle12));
        ...
        Room Jungle15               = new Room();
            Jungle15List.add(new Thing("moss", "A handful of tree moss", Jungle15));
            Jungle15List.add(new Thing("wood", "A log of Royal Palm wood", Jungle15));
        Room Jungle16               = new Room();
            Jungle16List.add(new Thing("wood", "A log of Royal Palm wood", Jungle16));
        Room Jungle17               = new Room();
            Jungle17List.add(new Thing("vines", "Thick vines, good for making rope", Jungle17));
            Jungle17List.add(new Thing("palm-leaves", "Large leaves, fallen from the Royal Palms overhead", Jungle17));
        Room Jungle18               = new Room();
            Jungle18List.add(new Thing("palm-leaves", "Large leaves, fallen from the Royal Palms overhead", Jungle18));
        ...
        Room Jungle21               = new Room();
            Jungle21List.add(new Thing("palm-leaves", "Large leaves, fallen from the Royal Palms overhead", Jungle21));
        Room Jungle22               = new Room();
            Jungle22List.add(new Thing("moss", "A handful of tree moss", Jungle22));
            Jungle22List.add(new Thing("palm-leaves", "Large leaves, fallen from the Royal Palms overhead", Jungle22));
        Room Jungle23               = new Room();
            Jungle23List.add(new Thing("vines", "Thick vines, good for making rope", Jungle23));
        Room CobaRiver24            = new Room();
        Room CobaRiver25            = new Room();
        Room Jungle26               = new Room();
            Jungle26List.add(new Thing("moss", "A handful of tree moss", Jungle26));
            Jungle26List.add(new Thing("wood", "A log of Royal Palm wood", Jungle26));
            Jungle26List.add(new Thing("vines", "Thick vines, good for making rope", Jungle26));
            Jungle26List.add(new Thing("palm-leaves", "Large leaves, fallen from the Royal Palms overhead", Jungle26));
        Room Jungle27               = new Room();
            Jungle27List.add(new Thing("vines", "Thick vines, good for making rope", Jungle27));
        Room Trap28                 = new Room();
        Room Dungeon29              = new Room();

        Room UnknownShrine30        = new Room();
        Room Jungle31               = new Room();
            Jungle31List.add(new Thing("palm-leaves", "Large leaves, fallen from the Royal Palms overhead", Jungle31));
        ...
        Room Jungle34               = new Room();
            Jungle34List.add(new Thing("vines", "Thick vines, good for making rope", Jungle34));
        Room CobaRiver35            = new Room();
        Room SavageVillage36        = new Room();
        Room Jungle37               = new Room();
            Jungle37List.add(new Thing("moss", "A handful of tree moss", Jungle37));
            Jungle37List.add(new Thing("vines", "Thick vines, good for making rope", Jungle37));
        Room Jungle38               = new Room();
            Jungle38List.add(new Thing("moss", "A handful of tree moss", Jungle38));
            Jungle38List.add(new Thing("palm-leaves", "Large leaves, fallen from the Royal Palms overhead", Jungle38));
        Room Cave39                 = new Room();

        Room Jungle40               = new Room();
            Jungle40List.add(new Thing("wood", "A log of Royal Palm wood", Jungle40));
        Room Trap41                 = new Room();
        Room SavageVillage42        = new Room();
        Room Jungle43               = new Room();
            Jungle43List.add(new Thing("moss", "A handful of tree moss", Jungle43));
        Room Jungle44               = new Room();
            Jungle44List.add(new Thing("moss", "A handful of tree moss", Jungle44));
            Jungle44List.add(new Thing("wood", "A log of Royal Palm wood", Jungle44));
            Jungle44List.add(new Thing("vines", "Thick vines, good for making rope", Jungle44));
            Jungle44List.add(new Thing("palm-leaves", "Large leaves, fallen from the Royal Palms overhead", Jungle44));
        ...
        Room Jungle46               = new Room();
            Jungle46List.add(new Thing("vines", "Thick vines, good for making rope", Jungle46));
        Room Jungle47               = new Room();
            Jungle47List.add(new Thing("palm-leaves", "Large leaves, fallen from the Royal Palms overhead", Jungle47));
        Room Jungle48               = new Room();
            Jungle48List.add(new Thing("moss", "A handful of tree moss", Jungle48));
            Jungle48List.add(new Thing("vines", "Thick vines, good for making rope", Jungle48));
        ...
        Room Jungle52               = new Room();
            Jungle52List.add(new Thing("wood", "A log of Royal Palm wood", Jungle52));
            Jungle52List.add(new Thing("vines", "Thick vines, good for making rope", Jungle52));
        ...
        Room Jungle55               = new Room();
            Jungle55List.add(new Thing("vines", "Thick vines, good for making rope", Jungle55));
        Room Jungle56               = new Room();
            Jungle56List.add(new Thing("moss", "A handful of tree moss", Jungle56));
            Jungle56List.add(new Thing("palm-leaves", "Large leaves, fallen from the Royal Palms overhead", Jungle56));
